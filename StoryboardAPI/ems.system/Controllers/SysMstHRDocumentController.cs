...
{
    [RoutePrefix("api/SysMstHRDocument")]
    [Authorize]
    public class SysMstHRDocumentController : ApiController
    {
        DaSysMstHRDocument objDaSysMstHRDocument = new DaSysMstHRDocument();
        ...
        {
            MdlSysMstHRDocument objhrdocument = new MdlSysMstHRDocument();
