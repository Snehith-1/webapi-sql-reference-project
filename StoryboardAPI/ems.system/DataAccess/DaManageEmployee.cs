      ...
      //  FnAgroHBAPIConn objFnSamAgroHBAPIConn = new FnAgroHBAPIConn();
        ...
        public bool DaEmployeeActiveSummary(employee_list objemployee)
        {
            try
            {
                msSQL = " Select distinct a.user_gid,c.erp_id,c.useraccess,a.api_codes,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name , " +
                    ...
                    " concat(j.address1,' ',j.address2,'/', j.city,'/', j.state,'/',k.country_name,'/', j.postal_code) as emp_address, " +
                    " d.designation_name,c.designation_gid,c.employee_gid,c.employee_emailid,e.branch_name,s.baselocation_name,c.baselocation_gid,concat(v.user_firstname,' ',v.user_lastname) as employeereporting_to, " +
                    " concat(r.user_firstname,' ',r.user_lastname) as created_by, CONVERT(NVARCHAR(19), a.created_date, 105) as created_date, c.employee_externalid, c.employee_entitychange_flag," +
                    " CASE " +
                    " WHEN a.user_status = 'Y' THEN 'Active'  " +
                    " WHEN a.user_status = 'N' THEN 'Inactive' " +
                    " END as user_status,c.department_gid,c.branch_gid, e.branch_name, g.department_name" +
        ...
        public bool DaEmployeeRelievedSummary(employee_list objemployee)
        {
            try
            {
                msSQL = "select b.employee_gid,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name, " +
                    " a.user_code ,concat(a.user_firstname,' ',a.user_lastname) as user_name , b.remarks, CONVERT(NVARCHAR(19), a.created_date, 105) as created_date, " +
                    " concat(e.user_firstname,' ',e.user_lastname) as created_by,CONVERT(NVARCHAR(19), a.exit_date, 105) as exit_date,concat(g.user_firstname, ' ', g.user_lastname) as employeereporting_to," +
        ...
        public bool DaEmployeePendingSummary(employee_list objemployee)
        {
            try
            {
                msSQL = " Select distinct a.user_gid,c.useraccess,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name , " +
                    ...
                    " WHEN a.user_status = 'Y' THEN 'Active'  " +
                    " WHEN a.user_status = 'N' THEN 'Inactive' " +
                    " END as user_status,c.department_gid,c.branch_gid, CONVERT(NVARCHAR(19), c.joining_date, 105) as joining_date," +
                    " e.branch_name, g.department_name, CONVERT(NVARCHAR(19), a.created_date, 105) as created_date,concat(r.user_firstname,' ',r.user_lastname) as created_by, b.employee_status" +
                    " FROM adm_mst_tuser a " +
                    " left join hrm_mst_temployee c on a.user_gid = c.user_gid " +
                    " left join hrm_mst_temployee p on c.employeereporting_to = p.employee_gid " +
        ...
        public bool DaEmployeeInactiveSummary(employee_list objemployee)
        {
            try
            {
                msSQL = " Select distinct a.user_gid,c.useraccess,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name ,"+
                        ...
                        " CONVERT(NVARCHAR(19), d.joining_date, 105) as joining_date,c.employee_gid, CONVERT(NVARCHAR(19), a.updated_date, 105) as updated_date, " +
        ...
        public bool DaPopReportingTo(reportingto_list objreportingto)
        {
            ...
            try
            {
                ...
                if (objGetReaderData!=null & objGetReaderData.Count != 0)
                {
        ...
        public bool DaEmployeeEditView(employee objemployee, string employee_gid)
        {
            ...
            try
            {
                msSQL = " Select distinct a.user_gid,c.useraccess,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name , user_firstname,user_lastname," +
                   ...
                   " WHEN a.user_status = 'Y' THEN 'Active'  " +
                   " WHEN a.user_status = 'N' THEN 'Inactive' " +
                   " END as user_access,a.user_status,c.department_gid,c.branch_gid,n.role_name, e.branch_name, g.department_name,c.marital_status,c.marital_status_gid,CONVERT(NVARCHAR(19), c.joining_date, 105) as joining_date, " +
                ...
                if (objGetReaderScalar!=null & objGetReaderScalar.Count!=0)
                {
                    ...
                    objemployee.subfunction_gid = objGetReaderScalar["subfunction_gid"].ToString();
                    objemployee.subfunction_name = objGetReaderScalar["subfunction_name"].ToString();
                    ...
                    objemployee.baselocation_gid = objGetReaderScalar["baselocation_gid"].ToString();
                    objemployee.baselocation_name = objGetReaderScalar["baselocation_name"].ToString();
                    ...
                    objemployee.joining_date = objGetReaderScalar["joining_date"].ToString();
                ...
                if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                {
                    lspermanentaddressGID = objGetReaderScalar["permanentaddress_gid"].ToString();
                    lstemporaryaddressGID = objGetReaderScalar["temporaryaddress_gid"].ToString();
                }
                msSQL = "select a.address1,a.address2,a.city,  a.postal_code,a.state,b.country_name,b.country_gid " +
                        "from adm_mst_taddress a " +
                        "left join adm_mst_tcountry b on a.country_gid = b.country_gid " +
                        "where address_gid = '" + lspermanentaddressGID + "' and  a.parent_gid = '" + employee_gid + "'";
                objGetReaderScalar = objdbconn.GetReaderScalar(msSQL);
                if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                {
                    objemployee.per_address1 = objGetReaderScalar["address1"].ToString();
                    objemployee.per_address2 = objGetReaderScalar["address2"].ToString();
                    objemployee.per_country_gid = objGetReaderScalar["country_gid"].ToString();
                    objemployee.per_country_name = objGetReaderScalar["country_name"].ToString();
                    objemployee.per_state = objGetReaderScalar["state"].ToString();
                    objemployee.per_city = objGetReaderScalar["city"].ToString();
                    objemployee.per_postal_code = objGetReaderScalar["postal_code"].ToString();
                }

                msSQL = "select a.address1,a.address2,a.city,  a.postal_code,a.state,b.country_name,b.country_gid " +
                        "from adm_mst_taddress a " +
                        "left join adm_mst_tcountry b on a.country_gid = b.country_gid " +
                        "where address_gid = '" + lstemporaryaddressGID + "' and  a.parent_gid = '" + employee_gid + "'";
                objGetReaderScalar = objdbconn.GetReaderScalar(msSQL);
                if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                {
                    objemployee.temp_address1 = objGetReaderScalar["address1"].ToString();
                    objemployee.temp_address2 = objGetReaderScalar["address2"].ToString();
                    objemployee.temp_country_gid = objGetReaderScalar["country_gid"].ToString();
                    objemployee.temp_country_name = objGetReaderScalar["country_name"].ToString();
                    objemployee.temp_state = objGetReaderScalar["state"].ToString();
                    objemployee.temp_city = objGetReaderScalar["city"].ToString();
                    objemployee.temp_postal_code = objGetReaderScalar["postal_code"].ToString();
                }
        ...
        public bool DaEmployeePendingEditView(employee objemployee, string employee_gid)
        {
            ...
            try
            {
                msSQL = " Select distinct a.user_gid,c.useraccess,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name , user_firstname,user_lastname," +
                  ...
                  " c.marital_status_gid,CONVERT(NVARCHAR(19), a.joiningdate, 105) as joiningdate,c.employee_joiningdate as joining_date,c.employee_personalno as personal_phone_no,c.personal_emailid,c.bloodgroup as bloodgroup_name,c.bloodgroup_gid " +
                   " FROM hrm_mst_temployee c " +
                   " left join adm_mst_tuser a on a.user_gid = c.user_gid " +
                   " left join adm_mst_tdesignation d on c.designation_gid = d.designation_gid " +
                   " left join hrm_mst_tbranch e on c.branch_gid = e.branch_gid " +
                ...
                if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                {
                    ...
                    if (objGetReaderScalar["joining_date"].ToString() != "")
                    {
                        objemployee.joiningdate = Convert.ToDateTime(objGetReaderScalar["joining_date"].ToString());
                    }
                    objemployee.personal_phone_no = objGetReaderScalar["personal_phone_no"].ToString();
                    objemployee.personal_emailid = objGetReaderScalar["personal_emailid"].ToString();
                    objemployee.bloodgroup_name = objGetReaderScalar["bloodgroup_name"].ToString();
        ...
        public bool DaEmployeeProfileView(employee objemployee, string employee_gid)
        {
            try
            {
                msSQL = " Select distinct a.user_gid,c.useraccess,case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name , user_firstname,user_lastname," +
                       ...
                       " WHEN a.user_status = 'Y' THEN 'Active'  " +
                       " WHEN a.user_status = 'N' THEN 'Inactive' " +
                       " END as user_access,a.user_status,c.department_gid,c.branch_gid,n.role_name, e.branch_name, g.department_name,c.marital_status,c.marital_status_gid,CONVERT(NVARCHAR(19), c.joining_date, 105) as joiningdate, " +
                       " c.employee_personalno as personal_phone_no,c.personal_emailid,c.bloodgroup as bloodgroup_name,c.bloodgroup_gid " +
                       " FROM hrm_mst_temployee c " +
                       " left join adm_mst_tuser a on a.user_gid = c.user_gid " +
                       " left join adm_mst_tdesignation d on c.designation_gid = d.designation_gid " +
                ...
                else
                {
                    ...
                    if (mnResult == 1)
                    {
                        ...
                        if (mnResult == 1)
                        {
                            ...
                            if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                            {
                                lsPerAddress_gid = objGetReaderScalar["permanentaddress_gid"].ToString();
                                lsTempAddress_gid = objGetReaderScalar["temporaryaddress_gid"].ToString();
                            }
            ...
            try
            {
                ...
                else
                {
                    ...
                    if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                    {
                        ...
                        lsentity_name = objGetReaderScalar["entity_name"].ToString();
                        lsemployee_emailid = objGetReaderScalar["employee_emailid"].ToString();
                        lsemployee_mobileno = objGetReaderScalar["employee_mobileno"].ToString();
                        lsuser_firstname = objGetReaderScalar["user_firstname"].ToString();
                        lsuser_lastname = objGetReaderScalar["user_lastname"].ToString();
                        lsuser_code = objGetReaderScalar["user_code"].ToString();
                        lsreporting_to = objGetReaderScalar["employeereporting_to"].ToString();
                        lsbase_location = objGetReaderScalar["baselocation_name"].ToString();
                        lsdepartment_gid = objGetReaderScalar["department_gid"].ToString();
                    ...
                    if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                    {
                        lsreporting_toname = objGetReaderScalar["employeereporting_to"].ToString();
                    }
                    msSQL = " Update hrm_mst_temployee set  " +
                     " branch_gid = '" + objemployee.branch_gid + "'," +
                     " baselocation_gid = '" + objemployee.baselocation_gid + "'," +
                    ...
                    if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                    {
                        ls_baselocation = objGetReaderScalar["baselocation_name"].ToString();
                    }
                    msSQL = "select erp_id from hrm_mst_temployee where employee_gid = '" + objemployee.employee_reportingto + "'";
                    objGetReaderScalar = objdbconn.GetReaderScalar(msSQL);
                    if (objGetReaderScalar != null & objGetReaderScalar.Count != 0)
                    {
                        lsrptngto_erpid = objGetReaderScalar["erp_id"].ToString();
                    }
        ...
        public void DaGetMyTaskCompleteSummary(string employee_gid, MdlTaskList values)
        {
            ...
            " CONVERT(NVARCHAR(19), a.completed_date, 105) as completed_date , a.task_status," +
            " CONVERT(NVARCHAR(19), a.created_date, 105) as created_date,concat(q.user_firstname,' ',q.user_lastname,' / ',q.user_code) as employee_name, p.employee_gid" +
        ...
        public void DaGetMyTaskPendingSummary(string employee_gid, MdlTaskList values)
        {
            msSQL = " select  a.task_name,a.taskinitiate_gid,a.task_remarks,concat(f.user_firstname,' ',f.user_lastname,' / ',f.user_code) as created_by," +
                    " CONVERT(NVARCHAR(19), a.created_date, 105) as created_date,  a.task_status," +
        ...
        public void DaGetTaskManagementPendingSummary(string employee_gid, MdlTaskList values)
        {
            msSQL = " select  a.task_name,a.taskinitiate_gid,a.task_remarks,a.task_status, " +
                    ...
                    " CONVERT(NVARCHAR(19), a.created_date, 105) as created_date, " +
                    "  CONVERT(NVARCHAR(19), a.taskassigned_date, 105) as taskassigned_date, " +
        ...
        public void DaGetTaskManagementNewSummary(string employee_gid, MdlTaskList values)
        {
            msSQL = " select  a.task_name,a.taskinitiate_gid,a.task_remarks, " +
                    " concat(f.user_firstname,' ',f.user_lastname,' / ',f.user_code) as created_by," +
                    " CONVERT(NVARCHAR(19), a.created_date, 105) as created_date,a.team_gid,a.team_name, " +
                    " concat(q.user_firstname,' ',q.user_lastname,' / ',q.user_code) as employee_name, p.employee_gid" +
                    " from sys_mst_ttaskinitiate a " +
                    " left join hrm_mst_temployee e on a.created_by = e.employee_gid " +
                    " left join adm_mst_tuser f on e.user_gid = f.user_gid  " +
        ...
        public void DaGetTaskManagementCompletedSummary(string employee_gid, MdlTaskList values)
        {
            msSQL = " select  a.task_name,a.taskinitiate_gid,a.task_remarks,task_completeremarks,completed_date, " +
                    " concat(f.user_firstname,' ',f.user_lastname,' / ',f.user_code) as created_by," +
                    " CONVERT(NVARCHAR(19), a.created_date, 105) as created_date, a.teammember_name, " +
                    " concat(q.user_firstname,' ',q.user_lastname,' / ',q.user_code) as employee_name, p.employee_gid" +
                    " from sys_mst_ttaskinitiate a " +
                    " left join hrm_mst_temployee e on a.created_by = e.employee_gid " +
                    " left join adm_mst_tuser f on e.user_gid = f.user_gid  " +
        ...
        public void GetTaskOnboardView(string employee_gid, MdlTaskViewInfoList values)
        {
            msSQL =" select  a.task_name,a.taskinitiate_gid,a.task_remarks, " +
                    " concat(f.user_firstname,' ',f.user_lastname,' / ',f.user_code) as created_by," +
                    " CONVERT(NVARCHAR(19), a.created_date, 105) as created_date, " +
                    " team_name,CONVERT(NVARCHAR(19), a.taskassigned_date, 105) as taskassigned_date,  " +
                    " teammanager_name,teammember_name,task_status, CONVERT(NVARCHAR(19), a.completed_date, 105) as completed_date, " +
        ...
        public void DaEmployeeExport(export values)
        {
            msSQL = " Select distinct case when c.entity_gid is null then c.entity_name else z.entity_name end as entity_name , " +
                   " a.user_code,concat(a.user_firstname,' ',a.user_lastname) as user_name ,CONVERT(NVARCHAR(19), a.employee_joiningdate, 105) as employee_joiningdate," +
                   " c.employee_gender,CONVERT(NVARCHAR(19), a.created_date, 105) as created_date," +
                   " concat(w.user_firstname,' ',w.user_lastname,' / ',w.user_code) as created_by, CONVERT(NVARCHAR(19), a.updated_date, 105) as updated_date, concat(y.user_firstname,' ',y.user_lastname,' / ',y.user_code) as updated_by, " +
                   " concat(j.address1,' ',j.address2,'/', j.city,'/', j.state,'/',k.country_name,'/', j.postal_code) as emp_address, " +
